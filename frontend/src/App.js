  ...
  return (
    <div className="h-screen w-screen overflow-hidden" data-testid="app-container">
      ...
      */}
      ...
      {/* Post Detail Drawer */}
      {/* Hero Card Drawer - Input Zero Protocol */}
            ...
            <div className="relative w-full h-full bg-white flex flex-col">
               ...
               <div className="h-[50%] w-full relative flex-shrink-0 bg-slate-100">
                  ...
                  <div className="absolute top-6 left-6 z-10">
                     <button 
                        onClick={() => { setShowDetailDrawer(false); setShowReportDialog(true); }}
               ...
               <div className="absolute bottom-8 left-6 right-6 pb-6 safe-area-bottom">
                  {selectedPost.status === 'active' && (!activeClaim || activeClaim.post_id !== selectedPost.id) ? (
                     <Button 
                        onClick={() => handleClaimItem(selectedPost)}
                        className="w-full h-20 text-2xl font-black bg-amber-400 hover:bg-amber-500 text-amber-950 rounded-2xl shadow-xl border-b-4 border-amber-600 active:border-b-0 active:translate-y-1 transition-all"
                     ...
                     <div className="w-full h-20 bg-slate-100 rounded-2xl flex items-center justify-center text-slate-400 font-bold text-xl border-2 border-slate-200">
                        COLLECTED
                     </div>
                  )}
               </div>
